...
PGPASSWORD="'' " psql -U aml -c "drop table if exists final_servidores_siape_cadastro;"
...
do
	...
	do
		...
		rm /home/jose/Desktop/scripts/files_servidores/servidores_"${i}"/2021${j}_Servidores_"${i}"
			...
			PGPASSWORD="'' " psql -U aml -c "drop table if exists tmp_servidores_siape_cadastro;"
			PGPASSWORD="'' " psql -U aml -c "CREATE TABLE public.""tmp_servidores_siape_cadastro"" (
	...
	UF_EXERCICIO varchar(1024) 
			...
			PGPASSWORD="'' " psql -U aml -c "\copy tmp_servidores_siape_cadastro
...
with 
	...
	encoding 'latin1';"
			...
			PGPASSWORD="'' " psql -U aml -c "CREATE TABLE public.""final_servidores_siape_cadastro"" (
	...
	PGPASSWORD="'' " psql -U aml -c "INSERT INTO public.""final_servidores_siape_cadastro"" 
SELECT 
	ID_SERVIDOR_PORTAL ,
	NOME ,
	CPF ,
	...
	UF_EXERCICIO 
FROM public.""tmp_servidores_siape_cadastro""";
